...
export const swaggerDocument: OpenAPIV3.Document = {
  ...
  paths: {
    ...
    "/activities/{id}/enroll": {
      post: {
        tags: ["Activities"],
        summary: "Enroll in an activity",
        description:
          "Enrolls the authenticated user in an open activity.",
        security: [{ cookieAuth: [] }],
        parameters: [
          {
            name: "id",
        ...
        responses: {
          ...
          400: {
            description: "Invalid UUID format or parameter.",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
              },
          ...
          409: {
            description:
              "Conflict: activity is not open, user already enrolled, or capacity reached.",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
              },
      ...
      delete: {
        tags: ["Activities"],
        summary: "Cancel enrollment in an activity",
        description:
          "Cancels the authenticated user's enrollment in the specified activity.",
        security: [{ cookieAuth: [] }],
        parameters: [
          {
            name: "id",
        ...
        responses: {
          204: {
            description: "Enrollment cancelled successfully. No content returned.",
          },
          400: {
            description: "Invalid UUID format or parameter.",
            content: {
          ...
          404: {
            description: "Activity or active enrollment not found.",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
              },
