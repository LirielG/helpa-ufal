...
import { ACTION_AREAS } from "../../dashboard/constants";
...
export function AreaField({ registration, error }: AreaFieldProps) {
  return (
    <div className="space-y-1">
      ...
      <div className="relative">
        <select
          ...
          {...registration}
        >
          {ACTION_AREAS.map((option) => (
            //value = label é intecional
